...
import { ReactComponent as ArrowUpIcon } from "../../assets/icons/arrow-up.svg";
 import kamiImg from "src/assets/logo.png";
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      {TOKEN_ADDRESS && (
                        <Button
                          variant="contained"
                          color="secondary"
                          onClick={addTokenToWallet("KAMI", TOKEN_ADDRESS, address)}
                        >

                    <img src={kamiImg} alt="" style={{ width: "32px" }} />
                           
                          <Typography variant="body1">KAMI</Typography>
                        </Button>
                      )}
                    </Box>
                  </Box>
