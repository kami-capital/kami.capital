...
import { TreasuryDashboard, Account, Calculator, NFT, Claim, Home } from "./views";
...
function App() {
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSafetyCheck()) {
      dispatch(info("Safety Check: Always verify you're on app.kamidao.capital!"));
    }
  }, []);
  ...
  useEffect(() => {
    ...
    if (connected) {
      if (networkId != 43114) {
        dispatch(switchNetwork({ provider: provider, networkId: 43114 }));
      } else {
        loadDetails("account");
      }
    }
