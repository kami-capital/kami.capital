...
import { abi as claimsABI } from "../../abi/KAMIV2.json";
import "./claim.scss";
...
function Claim() {
  ...
  const hasAllowance = useCallback(
    token => {
      if (token === "KAMIV2") return claimAllowance > 0;
      return 0;
    },
    [claimAllowance],
  );
                ...
                !hasAllowance("KAMIV2") ? (
                  <Box className="help-text">
                    <Typography variant="body1" className="presale-items" color="textSecondary">
                      <>
                        First time use <b>$KAMI</b>?
                        <br />
                        Please approve Firefly to allow you to claim $KAMI.
                      </>
                    </Typography>
                  </Box>
                ) : (
