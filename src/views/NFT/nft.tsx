      ...
      <div className="maxTopBox">
        <div className="TopBox">
          ...
          <div className="textBox">
            KAMI NFT is an important part of the KAMI   ecosystem. 
            Holders can obtain KAMI NFT Collections by minting. In coming days, KAMI NFT will be used for VESTING, and system governance.
          </div>
        </div>
        <div>
